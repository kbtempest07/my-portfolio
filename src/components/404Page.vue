        ...
        <div class="col-xs-12 ground-color text-center">
          <div class="container-error-404">
            <div class="clip"><div class="shadow">
              <span class="digit thirdDigit">4</span></div>
            </div>
            <div class="clip"><div class="shadow">
              <span class="digit secondDigit">0</span></div>
            </div>
            <div class="clip">
          ...
          <h2 class="h1">Sorry! The page you seek doesn't exist</h2>
          <h3>
            <router-link to="/" ref="homeLinkMain"
                         active-class="navbar-router-link-active"
                         :exact=true>Back to
              <img src="/static/images/home.png" alt="Home" id="home-image"></router-link>
          </h3>
        </div>
      </div>
    </div>
...
<script>
  /* eslint-disable prefer-const,no-unused-vars,one-var,no-plusplus */
